...
exports.report = function(username, reporter){
                        ...
                        <tr style="background-color:#111111; color: #ffffff;">
                            <td style="padding: 40px 30px 40px 30px;">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td align="center">
                                            <h2>User reported as fake</h2>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
                                            <p><a href="http://localhost:3000/profile/`+ reporter + `">`+ reporter +`</a> just reported <a href="http://localhost:3000/profile/`+ username +`">` + username +`</a> as fake</p>
                                            <br>
                                        </td>
                                    </tr>
                                </table>
    ...
    var mailOptions = {
        from: 'donotreply@matcha.com',
        to: 'ashleigh.m724@gmail.com',
        subject: 'Report user as fake',
        html: mail
    };
